...
function Sidebar() {
  return (
    <div className="hidden md:block h-full p-2 flex-col gap-2 text-black lg:flex ">
      <div className="bg-white h-[21%] rounded flex flex-col justify-around">
  ...
  <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-2 text-white md:h-[35] ">
